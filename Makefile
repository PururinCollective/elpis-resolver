...
CORE_SRC := \
  ...
  src/cookie.c src/rrl.c src/conflict.c src/checkpoint.c src/noise.c src/mesh.c src/meshq.c src/webui.c src/main.c
...
CRYPTO_SRC := \
  ...
  src/crypto/mldsa.c src/crypto/rand.c src/crypto/x25519.c src/crypto/chachapoly.c
